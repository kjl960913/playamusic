   ...
   struct gr_info_s *gr_info,int sfreq,int part2bits)
{
  ...
  //MessageBox(NULL, "DEQUANTIZE", "", MB_OK);
 ...
 */
  ...
  if(gr_info->block_type == 2) {
    ...
    register int *m,mc;
	  ...
	  //MessageBox(NULL, "DEQUANTIZE1", "", MB_OK);
  ...
  //MessageBox(NULL, "DEQUANTIZE3", "", MB_OK);
    ...
    for(i=0;i<2;i++) {
	  ...
	  //MessageBox(NULL, "DEQUANTIZE4", "", MB_OK);
    ...
    for(;l3 && (part2remain > 0);l3--) {
	  ...
	  //MessageBox(NULL, "DEQUANTIZE5", "", MB_OK);
 ...
 */
	  ...
	  //MessageBox(NULL, "DEQUANTIZE6", "", MB_OK);
